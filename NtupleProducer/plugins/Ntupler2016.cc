#include "TagAndProbe_Trigger/NtupleProducer/interface/Ntupler2016.h"
...
//
	Ntupler2016::Ntupler2016(const edm::ParameterSet& iConfig):
  ...
  effectiveAreas_( (iConfig.getParameter<edm::FileInPath>("effAreasConfigFile")).fullPath() )
	...
	//  tree_->Branch("isTrue"    , &isTrue_);
	 ...
	 // Electron Trigger branch
          tree_->Branch("deltaR_HLTEle27", &deltaR_HLTEle27);
	  ...
	  tree_->Branch("passFilterEle27_0p15"           ,  &passFilterEle27_0p15);
	  tree_->Branch("passFilterEle27_0p20"           ,  &passFilterEle27_0p20);
	  tree_->Branch("passFilterEle27_0p30"           ,  &passFilterEle27_0p30);
	  ...
	  tree_->Branch("L1EG_25"  ,  &L1EG_25) ;
	  tree_->Branch("L1EG_27"  ,  &L1EG_27) ;
	 ...
	 tree_->Branch("mu_segmentCompatibility",&mu_segmentCompatibility_);  
	  ...
	  tree_->Branch("passFilterIsoTkMu24" ,  &passFilterIsoTkMu24);
	  ...
	  tree_->Branch("passFilterMu17_TkMu8_leg1" ,  &passFilterMu17_TkMu8_leg1);
	  tree_->Branch("passFilterMu17_TkMu8_leg2" ,  &passFilterMu17_TkMu8_leg2);
	  tree_->Branch("passFilterMu17_TkMu8_IsoLeg" ,  &passFilterMu17_TkMu8_IsoLeg);
	  ...
	  tree_->Branch("passFilterMu23_Ele12_legMu" ,  &passFilterMu23_Ele12_legMu);
          tree_->Branch("passFilterMu23_Ele12_l120_legMu" ,  &passFilterMu23_Ele12_l120_legMu);
          tree_->Branch("passFilterMu23_Ele12_l123_legMu" ,  &passFilterMu23_Ele12_l123_legMu);
	 //Gen particles
	...
	void
	Ntupler2016::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
	{
	  using namespace std;
	  using namespace edm;
	  using namespace reco;
	  TString ele_filters[7] = {"hltEle25erWPTightGsfTrackIsoFilter","hltEle27WPTightGsfTrackIsoFilter","hltEle23Ele12CaloIdLTrackIdLIsoVLTrackIsoLeg1Filter","hltEle23Ele12CaloIdLTrackIdLIsoVLTrackIsoLeg2Filter","hltMu8TrkIsoVVLEle23CaloIdLTrackIdLIsoVLElectronlegTrackIsoFilter","hltMu12TrkIsoVVLEle23CaloIdLTrackIdLIsoVLElectronlegTrackIsoFilter","hltMu23TrkIsoVVLEle12CaloIdLTrackIdLIsoVLElectronlegTrackIsoFilter"};  
  ...
  iEvent.getByToken(eleMVAValuesMapTokenNoIso_ ,eleMVAnoIsovalue);
	...
	//      ele_isTrue_.clear();
	      ...
	      deltaR_HLTEle27.clear(); 
	      passFilterEle25.clear();
	      passFilterEle27.clear();
	      passFilterEle27_0p15.clear();
	      passFilterEle27_0p20.clear();
	      passFilterEle27_0p30.clear();
		...
		const auto el = electrons->ptrAt(i);
	      ...
	      bool filterEle27_0p15 = false;
	      bool filterEle27_0p20 = false;
	      bool filterEle27_0p30 = false;
		...
		bool foundTheLeg_0p15 = false;
		bool foundTheLeg_0p20 = false;
		bool foundTheLeg_0p30 = false;
		TString filter = filterToMatch_.at(iteTrigObj);
		for (unsigned int i = 0 ; i < legObjects[iteTrigObj].size() ; i++){
		  delR = deltaR(legObjects[iteTrigObj].at(i).eta(), legObjects[iteTrigObj].at(i).phi(),el->superCluster()->eta(),el->superCluster()->phi());
		  ...
		  if (delR<0.1) {
		     foundTheLeg = true;
                  ...
                  if (delR<0.15) {
                     foundTheLeg_0p15 = true;
                  }

                  if (delR<0.20) {
                     foundTheLeg_0p20 = true;
                  }

                  if (delR<0.30) {
                     foundTheLeg_0p30 = true;
                  }


             if(ele_filters[1].Contains(filter)) deltaR_HLTEle27.push_back(delR);

	//cout << "delR = " << delR << "   " << "foundTheLeg = " << foundTheLeg << " foundTheLeg_0p15 =  " << foundTheLeg_0p15 << "foundTheLeg_0p20 = " << foundTheLeg_0p20 << "foundTheLeg_0p30 = " << foundTheLeg_0p30 << endl;
	...
	//
		...
		if(ele_filters[0].Contains(filter) && foundTheLeg)  filterEle25 = true;
		if(ele_filters[1].Contains(filter) && foundTheLeg)  filterEle27 = true;
		if(ele_filters[1].Contains(filter) && foundTheLeg_0p15)  filterEle27_0p15 = true;
		if(ele_filters[1].Contains(filter) && foundTheLeg_0p20)  filterEle27_0p20 = true;
		if(ele_filters[1].Contains(filter) && foundTheLeg_0p30)  filterEle27_0p30 = true;
		...
		if(ele_filters[4].Contains(filter) && foundTheLeg)  filterMu8_Ele23_legEle = true;
		if(ele_filters[5].Contains(filter) && foundTheLeg)  filterMu12_Ele23_legEle = true;
		if(ele_filters[6].Contains(filter) && foundTheLeg)  filterMu23_Ele12_legEle = true;
	      ...
	      passFilterEle27_0p15          .push_back(filterEle27_0p15);
	      passFilterEle27_0p20          .push_back(filterEle27_0p20);
	      passFilterEle27_0p30          .push_back(filterEle27_0p30);
...
//  if(isAOD) iEvent.getByToken(muonsToken_,muons);
 ...
 // Handle over L1-muon
  ...
  if(doMuon_)
  {
     ...
     passFilterIsoTkMu24       .clear();
     passFilterMu17_Mu8_leg1 .clear();
     passFilterMu17_Mu8_leg2 .clear();
     passFilterMu17_Mu8_IsoLeg .clear();
     passFilterMu17_TkMu8_leg1 .clear(); 
     passFilterMu17_TkMu8_leg2 .clear();
     passFilterMu17_TkMu8_IsoLeg .clear();
     passFilterMu8_Ele23_legMu.clear();
     passFilterMu12_Ele23_legMu.clear();
     passFilterMu23_Ele12_legMu.clear();
     passFilterMu23_Ele12_l120_legMu.clear();
     passFilterMu23_Ele12_l123_legMu.clear();
     ...
     for(unsigned i=0; i < muons->size();++i ) {
       ...
       float delRL120_23=9999;
       float delRL123_23=9999;
       float delRL1_5_toBeChecked=9999;
       float delRL1_7_toBeChecked=9999;
       float delRL1_23_toBeChecked=9999;
       float delRL120_23_toBeChecked=9999;
       float delRL123_23_toBeChecked=9999;
       ...
       if (L1muons.isValid()) {
        for(int i=L1muons->getFirstBX(); i<=L1muons->getLastBX();i++) {
          for(std::vector<l1t::Muon>::const_iterator L1mu = L1muons->begin(i); L1mu != L1muons->end(i); ++L1mu) {
                ...
                if((L1MuPt >= 5) && (L1MuQual>=12 && L1MuQual<=15))
                {
                   delRL1_5 = deltaR(L1MuEta,L1MuPhi ,mu->eta(),mu->phi());
                   if (delRL1_5<temp1) temp1 = delRL1_5;
                }

                if((L1MuPt >= 5 || L1MuPt >= 7) && (L1MuQual>=12 && L1MuQual<=15))
                {
                   delRL1_7 = deltaR(L1MuEta,L1MuPhi ,mu->eta(),mu->phi());
                   if (delRL1_7<temp2) temp2 = delRL1_7;
                }
                if((L1MuPt >= 20 || L1MuPt >= 23) && (L1MuQual>=12 && L1MuQual<=15))
                {
                  delRL1_23 = deltaR(L1MuEta,L1MuPhi ,mu->eta(),mu->phi());
                   if (delRL1_23<temp3) temp3 = delRL1_23;
                }
                if((L1MuPt >= 20) && (L1MuQual>=12 && L1MuQual<=15))
                {
                  delRL120_23 = deltaR(L1MuEta,L1MuPhi ,mu->eta(),mu->phi());
                   if (delRL120_23<temp4) temp4 = delRL120_23;
                }
                if((L1MuPt >= 23) && (L1MuQual>=12 && L1MuQual<=15))
                {
                  delRL123_23 = deltaR(L1MuEta,L1MuPhi ,mu->eta(),mu->phi());
                   if (delRL123_23<temp5) temp5 = delRL123_23;
                }

                if(temp1<0.3) delRL1_5_toBeChecked=temp1;
                if(temp2<0.3) delRL1_7_toBeChecked=temp2;
                if(temp3<0.3) delRL1_23_toBeChecked=temp3;
                if(temp4<0.3) delRL120_23_toBeChecked=temp4;
                if(temp5<0.3) delRL123_23_toBeChecked=temp5;
           }
         }  
       }

       bool filterIsoMu24 = false;
       bool filterIsoTkMu24 = false;
       bool filterMu17_Mu8_Leg1 = false;
       bool filterMu17_Mu8_Leg2 = false;
       bool filterMu17_Mu8_IsoLeg = false;
       bool filterMu17_TkMu8_Leg1 = false;
       bool filterMu17_TkMu8_Leg2 = false;
       bool filterMu17_TkMu8_IsoLeg = false;
       bool filterMu8_Ele23_legMu = false;
       bool filterMu12_Ele23_legMu = false;
       bool filterMu23_Ele12_legMu = false;
       bool filterMu23_Ele12_l120_legMu = false;
       bool filterMu23_Ele12_l123_legMu = false;
      ...
      // Trigger matching
       for (unsigned int iteTrigObj = 0 ; iteTrigObj < filterToMatch_.size() ; iteTrigObj++){
          ...
          if(mu_filters[1].Contains(filter) && foundTheLeg)  filterIsoTkMu24 = true;
          ...
          if(mu_filters[5].Contains(filter) && foundTheLeg)  {filterMu17_TkMu8_Leg1 = true; }
          if(mu_filters[6].Contains(filter) && foundTheLeg)  {filterMu17_TkMu8_Leg2 = true; }
          if(mu_filters[7].Contains(filter) && foundTheLeg)  {filterMu17_TkMu8_IsoLeg = true; }
          if(mu_filters[3].Contains(filter) && foundTheLeg && legObjects[iteTrigObj].at(iPass).pt()>=8 && delRL1_5_toBeChecked < 0.3 )  {filterMu8_Ele23_legMu = true; }
          if(mu_filters[3].Contains(filter) && foundTheLeg && legObjects[iteTrigObj].at(iPass).pt()>=12 && delRL1_7_toBeChecked < 0.3 )  {filterMu12_Ele23_legMu = true; }
          if(mu_filters[3].Contains(filter) && foundTheLeg && legObjects[iteTrigObj].at(iPass).pt()>=23 && delRL1_23_toBeChecked < 0.3 ) {filterMu23_Ele12_legMu = true; }
          if(mu_filters[3].Contains(filter) && foundTheLeg && legObjects[iteTrigObj].at(iPass).pt()>=23 && delRL120_23_toBeChecked < 0.3 ) {filterMu23_Ele12_l120_legMu = true; }
          if(mu_filters[3].Contains(filter) && foundTheLeg && legObjects[iteTrigObj].at(iPass).pt()>=23 && delRL123_23_toBeChecked < 0.3 ) {filterMu23_Ele12_l123_legMu = true; }
     
       }
//TString mu_filters[11] = {"hltL3crIsoL1sMu22L1f0L2f10QL3f24QL3trkIsoFiltered0p09","hltL3fL1sMu22L1f0Tkf24QL3trkIsoFiltered0p09","hltL3fL1sDoubleMu114L1f0L2f10OneMuL3Filtered17","hltL3pfL1sDoubleMu114ORDoubleMu125L1f0L2pf0L3PreFiltered8","hltDiMuonGlb17Glb8RelTrkIsoFiltered0p4","hltL3fL1sDoubleMu114L1f0L2f10L3Filtered17","hltDiMuonGlbFiltered17TrkFiltered8","hltDiMuonGlb17Trk8RelTrkIsoFiltered0p4","hltMu8TrkIsoVVLEle23CaloIdLTrackIdLIsoVLMuonlegL3Filtered8","hltMu12TrkIsoVVLEle23CaloIdLTrackIdLIsoVLMuonlegL3IsoFiltered12","hltMu23TrkIsoVVLEle12CaloIdLTrackIdLIsoVLMuonlegL3IsoFiltered23"};
       passFilterIsoMu24      .push_back(filterIsoMu24);
       passFilterIsoTkMu24       .push_back(filterIsoTkMu24);
       ...
       passFilterMu17_TkMu8_leg1 .push_back(filterMu17_TkMu8_Leg1);
       passFilterMu17_TkMu8_leg2 .push_back(filterMu17_TkMu8_Leg2);
       passFilterMu17_TkMu8_IsoLeg .push_back(filterMu17_TkMu8_IsoLeg);
       ...
       passFilterMu23_Ele12_l120_legMu .push_back(filterMu23_Ele12_l120_legMu);
       passFilterMu23_Ele12_l123_legMu .push_back(filterMu23_Ele12_l123_legMu);
...
/*
void 
Ntupler2016::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
Ntupler2016::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
Ntupler2016::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
Ntupler2016::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
Ntupler2016::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
int Ntupler2016::matchToTruth(const edm::Ptr<reco::GsfElectron> el, 
  ...
  if( ancestorPID == -999 && ancestorStatus == -999 ){
    ...
    // Complain.
    printf("Ntupler2016: ERROR! Electron does not apper to have a non-electron parent\n");
    return UNMATCHED;
  }
...
bool Ntupler2016::cmd(const reco::GenParticle & s1, const reco::GenParticle & s2)
{  
   return s1.pt() > s2.pt();
}

void Ntupler2016::findFirstNonElectronMother(const reco::Candidate *particle,
						 int &ancestorPID, int &ancestorStatus){

  if( particle == 0 ){
    printf("Ntupler2016: ERROR! null candidate pointer, this should never happen\n");
    return;
  }
...
bool
Ntupler2016::hasWZasMother(const reco::GenParticle  p)  
{
    bool foundZ = false;
...
/*void Ntupler2016::printCutFlowResult(vid::CutFlowResult &cutflow){
