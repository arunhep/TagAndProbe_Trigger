#ifndef Ntupler2016_h
#define Ntupler2016_h
...
class Ntupler2016 : public edm::EDAnalyzer {
   public:
      explicit Ntupler2016(const edm::ParameterSet&);
      ~Ntupler2016();
...
//      edm::EDGetToken muonsToken_;
  ...
  // Trigger names and decision 
     ...
     std::vector<float> deltaR_HLTEle27; 
   //  std::vector<bool> passFilterEle35;
     std::vector<bool> passFilterEle25;
     std::vector<bool> passFilterEle27;
     std::vector<bool> passFilterEle27_0p15;
     std::vector<bool> passFilterEle27_0p20;
     std::vector<bool> passFilterEle27_0p30;
     ...
     std::vector<bool> L1EG_25 ;
     std::vector<bool> L1EG_27 ;
    ...
    // All Muon variables 
     ...
     std::vector<bool> passFilterIsoTkMu24;
     std::vector<bool> passFilterMu17_Mu8_leg1;
     std::vector<bool> passFilterMu17_Mu8_leg2;
     std::vector<bool> passFilterMu17_Mu8_IsoLeg;
     std::vector<bool> passFilterMu17_TkMu8_leg1;
     std::vector<bool> passFilterMu17_TkMu8_leg2;
     std::vector<bool> passFilterMu17_TkMu8_IsoLeg;
     ...
     std::vector<bool> passFilterMu23_Ele12_l120_legMu;
     std::vector<bool> passFilterMu23_Ele12_l123_legMu;
